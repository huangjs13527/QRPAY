...
namespace ECardPass.Project.Infrastructure.XML
{
    ...
    public static class XmlHelper
    {
        ...
        /// <returns></returns>
        public static string SerializeToXmlStr<T>(T obj, bool omitXmlDeclaration, Dictionary<string, string> xmls = null)
        {
            return XmlSerialize(obj, omitXmlDeclaration, xmls);
        }
        ...
        public static T Deserialize<T>(string xmlOfObject) where T : class
        {
            ...
            using (TextReader reader = new StringReader(xmlOfObject))
            {
        ...
        public static string XmlSerialize<T>(T obj, bool omitXmlDeclaration, Dictionary<string, string> namespaceSetting = null)
        {
            ...
            */
            ...
            var xmlSerializerNamespaces = new XmlSerializerNamespaces();
            if (namespaceSetting != null && namespaceSetting.Any())
            {
                foreach (var item in namespaceSetting)
                {
            ...
            return Encoding.UTF8.GetString(stream.ToArray()); //writer.ToString();
                                                              ...
                                                              //return Encoding.GetEncoding("GB2312").GetString(stream.ToArray()); //writer.ToString();
        }
